...
namespace CryptoCoin.UWP.Client.Adapters
{
    ...
    /// </summary>
    public class CryptoCoinNavigationAdapter : INavigationServiceExtensions
    {
        ...
        public CryptoCoinNavigationAdapter(Frame frame, bool treatViewAsLoaded = false)
        {
            this.frame = frame;
        ...
        {
            MainThread.InvokeOnMainThreadAsync(() => frame.Navigate(sourcePageType, null, new Windows.UI.Xaml.Media.Animation.DrillInNavigationTransitionInfo()));
            return true;
        }
        ...
        public Task OpenModalPageByViewModalAsync<T>(T viewmodel)
        {
            throw new NotImplementedException();
        }

        public Task OpenModalPageWithLoaderByViewModal<T>(T viewmodel)
        {
            throw new NotImplementedException();
        }
        ...
        //Content Dialogue Navigation
        public Task OpenContentDialogueByViewModelAsync<T>(T viewModel)
        {
            throw new NotImplementedException();

            //All Navigation needs to be managed via the adapter -- If the item is a content dialogue,
            //make sure to use these api -- I might have to create some validation, to make sure 
            //that the pages are content dialogue based
        }

        public Task OpenContentDialogueWithLoaderByViewModelAsync<T>(T viewModel)
        {
            throw new NotImplementedException();
        }
    }
