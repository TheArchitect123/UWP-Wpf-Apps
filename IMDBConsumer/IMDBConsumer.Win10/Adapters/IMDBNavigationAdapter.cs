...
namespace IMDBConsumer.UWP.Client.Adapters
{
    ...
    /// </summary>
    public class IMDBNavigationAdapter : INavigationServiceExtensions
    {
        ...
        public IMDBNavigationAdapter(Frame frame, bool treatViewAsLoaded = false)
        {
            this.frame = frame;
